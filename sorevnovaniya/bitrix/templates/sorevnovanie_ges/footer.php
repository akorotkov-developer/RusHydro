...
<?$dir = $APPLICATION->GetCurDir();?>
		...
		<div class="intersite-navi">
			<div class="intersite-navi_link" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/tmp/topblock1.png)"><a href="/ws"><span>Корпоративный Чемпионат <br> Группы РусГидро <br> по стандартам Worldskills</span></a></div>
			<div class="intersite-navi_link" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/tmp/topblock2.jpg)"><a href="/tes"><span>Корпоративные соревнования<br>оперативного персонала тэс<small>с поперечными связями</small></span></a></div>
		</div>
