                ...
                if (false && IsModuleInstalled("search")):
                    ...
                    <div class="forum-search-input">
                        <form action="<?= $arResult["URL_TEMPLATES"]["SEARCH"] ?>" method="GET" class="forum-form">
                            ...
                            <input type="q" value="<?= GetMessage("F_SEARCH_TEXT") ?>"
                                   onfocus="this.value='';this.onfocus=function(){};this.form.search_submit.onclick=function(){}"/>
                ...
                if ($arParams["SHOW_FORUMS"] == "Y" && !empty($arResult["GROUPS_FORUMS"])):
                    ...
                    <div class="forum-rapid-access-items">
                        <form action="<?= $arResult["URL_TEMPLATES"]["INDEX"] ?>" method="GET" class="forum-form">
                            ...
                            <select name="FID" class="forum-selector-single"
                ...
                <div class="forum-legend-info">
                    <div class="forum-legend-item">
                        <div class="forum-icon-container">
                            <div class="forum-icon forum-icon-newposts"><!-- ie --></div>
                        </div>
                    ...
                    if ($this->__page == "list"):
                        ...
                        <div class="forum-legend-item">
                            <div class="forum-icon-container">
                                <div class="forum-icon forum-icon-moved"><!-- ie --></div>
                            </div>
                            <span><?= GetMessage("F_INFO_MOVED") ?></span></div>
                        <div class="forum-legend-item">
                            <div class="forum-icon-container">
                                <div class="forum-icon forum-icon-sticky"><!-- ie --></div>
                            </div>
                            <span><?= GetMessage("F_INFO_PINNED") ?></span></div>
                        <div class="forum-legend-item">
                            <div class="forum-icon-container">
                                <div class="forum-icon forum-icon-closed"><!-- ie --></div>
                            </div>
