...
<?else:?>
    ...
    <form method="post" action="<?=$APPLICATION->GetCurDir()?>?formSend=Y&register=yes" name="regform" enctype="multipart/form-data">
        <?
        if($arResult["BACKURL"] <> ''):
            ?>
        ...
        <table>
            ...
            <input type="hidden" name="UF_AUCTION_FORUM" value="1">
            <?// ********************* User properties ***************************************************?>
