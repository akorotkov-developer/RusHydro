...
$APPLICATION->SetTitle("Финалисты");?>
<a href="/tes/teams/finalists/rating/" class="btn-rating" style="top:-51px; margin-bottom:-20px;">рейтинг голосования</a> 
...
?>
<?$APPLICATION->IncludeComponent("bitrix:news.list", "finalists", array(
	"IBLOCK_TYPE" => "teams",
	"IBLOCK_ID" => "26",
	"NEWS_COUNT" => "",
