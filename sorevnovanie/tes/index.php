...
<div id="col-left"> 	<?$APPLICATION->IncludeComponent("bitrix:news.list", "banners", array(
  ...
  <ul class="bl-txt"> 					 
    <li class="bl-first"><a class="bl-name" href="/tes/teams/" >Голосуй за любимую команду!</a> 
      <div style="margin-top: 30px;"><a href="/tes/teams/" ><img src="/upload/medialibrary/1d9/img-like.gif" title="img-like.gif" border="0" alt="img-like.gif" width="91" height="43"  /></a></div>
     						 
      <div class="bl-desc"></div>
     					</li>
   					 
   					 
    <li> 						<a class="bl-name" href="/tes/teams/rating/" >По итогам зрительского голосования лидирует</a> 						 
    ...
    <li> 						<a class="bl-name" href="/tes/letters/" >Народная <br/>журналистика</a> 						 
      <div class="bl-desc"><a class="bl-name" href="/tes/letters/" ><img src="/upload/medialibrary/d8c/img-newspaper.gif" title="img-newspaper.gif" border="0" alt="img-newspaper.gif" width="64" height="74"  /></a></div>
     					</li>
   				</ul>
				<div class="clear"></div>
...
<a href="/tes/news/rss/" class="rss-link" style="top:-2px;">Новости в формате RSS</a> 	<a href="/tes/news/" class="arr-link" >Все новости</a>
